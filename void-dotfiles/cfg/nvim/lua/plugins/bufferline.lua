...
return {
	{
		...
		opts = {
			...
			highlights = {
				fill = { bg = "#1b1b1b", fg = "#1b1b1b" },
				background = { bg = "#1b1b1b" },
				separator = { bg = "#1b1b1b", fg = "#1b1b1b" },
				separator_selected = { fg = "#1b1b1b" },
				separator_visible = { fg = "#1b1b1b" },
				close_button_visible = { bg = "#1b1b1b" },
				close_button = { bg = "#1b1b1b" },
